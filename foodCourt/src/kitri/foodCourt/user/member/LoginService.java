...
//    		}
	...
	public void signUp() {
		...
		String quary = "INSERT INTO fook_user(user_id, password, name, phone_first, "
				...
				+ "enable, join_date, secession_date) " + 
	...
	public void findid() {
		...
		String user_name = logc.findId.middleTF.getText();
		String phF = logc.findId.comboBox.getSelectedItem().toString();
		String phM = logc.findId.lastTF.getText();
		String phL = logc.findId.nameTF.getText();
        ...
        try {
			...
			while(rs.next()){
				...
				if (user_name.equals(DBuser_id) || phF.equals(DBphF) || phM.equals(DBphM) ||
						phL.equals(DBphL)) {
					
					logc.findIdCheck.nameL.setText(Username);
